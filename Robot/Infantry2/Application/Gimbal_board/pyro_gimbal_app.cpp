...
void gimbal_config() {
    ...
    gimbal_deps_ptr->motor.yaw = new dji_gm_6020_motor_drv_t(dji_motor_tx_frame_t::id_5,bsp_can::can2);
    ...
    //pid
    gimbal_deps_ptr->pid.yaw_pos_pid = new pid_t(15.5f, 0.0f, 0.0f, 0.0f, 10.0f, 50.0f, 1, 20.0f, 1, 4);
    gimbal_deps_ptr->pid.yaw_spd_pid = new pid_t(0.3f, 0.08f, 0.0003f, 1.5f, 3.0f, 50.0f, 1, 20.0f, 1, 4);
